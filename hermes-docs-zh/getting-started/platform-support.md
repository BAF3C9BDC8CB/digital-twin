...
(x86_64, aarch64)
docker pull
Docker installs do not support
hermes update
. Updating is done by running a new image.
Tier 2
​
...
Unsupported
​
These platforms and distribution methods are
not
supported.
...
PRs to fix them will
not
be accepted, and any code that keeps compatibility with them may be removed at any point.
...
If you are using an unsupported distribution method, please read the
the installation guide
to learn how to switch to a supported one.
编辑此页